    ...
    return {
      ...
      right: (
        <style.providerButtons>
          { props.isMobile && showMinimumBalanceWarning && renderMinimumBalanceWarning() }
          {
      ...
      <style.root>
        {
          left &&
          <style.leftPanel>
            {props.isMobile && <ModalCloseButton onClick={props.onClose} />}
            {left}
          </style.leftPanel>
        }
        {
